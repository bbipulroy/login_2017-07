...
class Setup_department extends Root_Controller
{
    private  $message;
    public $permissions;
    ...
    public function __construct()
    {
        parent::__construct();
        $this->message="";
        $this->permissions=User_helper::get_permission('Setup_department');
        $this->controller_url='setup_department';
    ...
    private function check_validation()
    {
        ...
        $this->form_validation->set_rules('department[name]',$this->lang->line('LABEL_NAME'),'required');
