...
class Setup_location_division extends Root_Controller
{
    private  $message;
    public $permissions;
    ...
    public function __construct()
    {
        parent::__construct();
        $this->message="";
        $this->permissions=User_helper::get_permission('Setup_location_division');
        $this->controller_url='setup_location_division';
    }
    ...
    private function system_list()
    {
        if(isset($this->permissions['action0']) && ($this->permissions['action0']==1))
        {
            ...
            $ajax['status']=true;
            $ajax['system_content'][]=array("id"=>"#system_content","html"=>$this->load->view("setup_location_division/list",$data,true));
            if($this->message)
            {
    ...
    private function system_edit($id)
    {
        if(isset($this->permissions['action2']) && ($this->permissions['action2']==1))
        {
            ...
            $ajax['system_page_url']=site_url($this->controller_url.'/index/edit/'.$division_id);
            $this->json_return($ajax);
        }
        else
        {
