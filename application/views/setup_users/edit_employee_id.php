...
?>
<form id="save_form" action="<?php echo site_url($CI->controller_url.'/index/save_employee_id');?>" method="post">
    ...
    <div class="row widget">
        ...
        <div style="" class="row show-grid">
            ...
            <div class="col-sm-4 col-xs-8">
                <input type="text" name="new_employee_id"  class="form-control" value="<?php echo $employee_id;?>" >
            </div>
        </div>
