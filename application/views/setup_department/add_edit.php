    ...
    <div class="row widget">
        ...
        <div class="row show-grid">
            ...
            <div class="col-sm-4 col-xs-8">
                <input type="text" name="department[name]" id="name" class="form-control" value="<?php echo $department['name'];?>"/>
            </div>
        </div>
        ...
        <div style="" class="row show-grid">
            ...
            <div class="col-sm-4 col-xs-8">
                <input type="text" name="department[ordering]" id="ordering" class="form-control" value="<?php echo $department['ordering'] ?>" >
            </div>
        </div>
    </div>
    <div class="clearfix"></div>
