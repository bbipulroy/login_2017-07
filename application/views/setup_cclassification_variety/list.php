        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                autoheight: true,
                columns: [
                    { text: '<?php echo $CI->lang->line('ID'); ?>', dataField: 'id',width:'40',cellsalign: 'right'},
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_WHOSE'); ?>', dataField: 'whose'},
                    { text: '<?php echo $CI->lang->line('LABEL_COMPETITOR_NAME'); ?>', dataField: 'competitor_name'},
                    { text: '<?php echo $CI->lang->line('LABEL_STOCK_ID'); ?>', dataField: 'stock_id'},
