...
<form class="form_valid" id="save_form" action="<?php echo site_url($CI->controller_url.'/index/save');?>" method="post">
    <input type="hidden" id="id" name="id" value="<?php echo $hybrid['id']; ?>" />
    ...
    <div class="row widget">
        ...
        <div class="row show-grid">
            ...
            <div class="col-sm-4 col-xs-8">
                <input type="text" name="hybrid[name]" id="name" class="form-control" value="<?php echo $hybrid['name'];?>"/>
            </div>
        </div>
        <div class="row show-grid">
            <div class="col-xs-4">
            ...
            <div class="col-sm-4 col-xs-8">
                <textarea name="hybrid[description]" class="form-control"><?php echo $hybrid['description']; ?></textarea>
            </div>
        </div>
        <div style="" class="row show-grid">
            ...
            <div class="col-sm-4 col-xs-8">
                <input type="text" name="hybrid[ordering]" id="ordering" class="form-control" value="<?php echo $hybrid['ordering'] ?>" >
            </div>
        </div>
        <div style="" class="row show-grid">
            <div class="col-xs-4">
            ...
            <div class="col-sm-4 col-xs-8">
                <select id="status" name="hybrid[status]" class="form-control">
                    <!--<option value=""></option>-->
                    <option value="<?php echo $CI->config->item('system_status_active'); ?>"
                        <?php
                        if ($hybrid['status'] == $CI->config->item('system_status_active')) {
                    ...
                    <option value="<?php echo $CI->config->item('system_status_inactive'); ?>"
                        <?php
                        if ($hybrid['status'] == $CI->config->item('system_status_inactive')) {
                            echo "selected='selected'";
                        }
