...
<form class="form_valid" id="save_form" action="<?php echo site_url($CI->controller_url.'/index/save');?>" method="post">
    <input type="hidden" id="id" name="id" value="<?php echo $office['id']; ?>" />
    ...
    <div class="row widget">
        ...
        <div class="row show-grid">
            ...
            <div class="col-sm-4 col-xs-8">
                <input type="text" name="office[name]" id="name" class="form-control" value="<?php echo $office['name'];?>"/>
            </div>
        </div>
        <div class="row show-grid">
            <div class="col-xs-4">
            ...
            <div class="col-sm-4 col-xs-8">
                <textarea name="office[address]" class="form-control"><?php echo $office['address']; ?></textarea>
            </div>
        </div>
        <div style="" class="row show-grid">
            ...
            <div class="col-sm-4 col-xs-8">
                <input type="text" name="office[ordering]" id="ordering" class="form-control" value="<?php echo $office['ordering'] ?>" >
            </div>
        </div>
    </div>
